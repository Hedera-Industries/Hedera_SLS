...
C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430.xs
C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430X.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430X.xs
C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430X_small.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/MSP430X_small.xs
C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/package.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/package.xs
...
ti.targets.msp430.elf.packageBase ?= C:/ti/xdctools_3_25_04_88/packages/ti/targets/msp430/elf/
...
.dlls,e430X .dlls: idle.pe430X

-include package/cfg/idle_pe430X.mak
-include package/cfg/idle_pe430X.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/idle_pe430X.dep
endif
idle.pe430X: package/cfg/idle_pe430X.xdl
	@


ifeq (,$(wildcard .libraries,e430X))
idle.pe430X package/cfg/idle_pe430X.c: .libraries,e430X
endif

package/cfg/idle_pe430X.c package/cfg/idle_pe430X.h package/cfg/idle_pe430X.xdl: override _PROG_NAME := idle.xe430X
package/cfg/idle_pe430X.c: package/cfg/idle_pe430X.cfg

clean:: clean,e430X
	-$(RM) package/cfg/idle_pe430X.cfg
	-$(RM) package/cfg/idle_pe430X.dep
	-$(RM) package/cfg/idle_pe430X.c
	-$(RM) package/cfg/idle_pe430X.xdc.inc

clean,e430X::
	-$(RM) idle.pe430X
.executables,e430X .executables: idle.xe430X

idle.xe430X: |idle.pe430X

-include package/cfg/idle.xe430X.mak
idle.xe430X: package/cfg/idle_pe430X.oe430X 
	$(RM) $@
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/lnk430 -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/idle_pe430X.oe430X   package/cfg/idle_pe430X.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
	
idle.xe430X: export C_DIR=
idle.xe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
idle.xe430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

idle.test test,e430X test: idle.xe430X.test

idle.xe430X.test:: idle.xe430X
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 idle.xe430X.test
else
	@$(MSG) running $<  ...
	$(call EXEC.idle.xe430X, ) 
endif

clean,e430X::
	-$(RM) .tmp,idle.xe430X,0,*
...
clean,e430X::
	-$(RM) idle.xe430X
clean:: 
	-$(RM) package/cfg/idle_pe430X.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
idle_pe430X.oe430X,copy : package/cfg/idle_pe430X.oe430X
idle_pe430X.se430X,copy : package/cfg/idle_pe430X.se430X
